        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>Quality Navigator</li>
              <li>Risk Management Navigator</li>
              <li>Reliability Navigator</li>
              <li className="text-white font-medium">Procurement Navigator</li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              ...
              {' '}<a href="mailto:support@ap-learningsystems.com" className="text-primary-300 hover:text-primary-200 underline">support@ap-learningsystems.com</a>.
            </p>
          </div>
        </div>
