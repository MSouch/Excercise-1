...
export const useProgress = () => {
  ...
  const loadProgress = () => {
    try {
      ...
      const stored = localStorage.getItem('procurementProgress')
      ...
      if (stored) {
        ...
        // Save default progress immediately
        localStorage.setItem('procurementProgress', JSON.stringify(defaultProgress))
      }
    } catch (error) {
  ...
  const saveProgress = (progressData) => {
    try {
      ...
      localStorage.setItem('procurementProgress', JSON.stringify(progressData))
      setProgress(progressData)
    } catch (error) {
  ...
  const updateProgress = async (challengeId, answers, isCorrect, score) => {
    try {
      ...
      console.log('useProgress: Updated progress object:', updatedProgress)
  ...
  console.log('useProgress: Returning progress state:', {
    progress,
    loading,
